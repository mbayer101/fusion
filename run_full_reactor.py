...
print("=== 1. Setting up Cross Sections & Materials (Including Divertor) ===")
...
# Divertor Material (Pure Tungsten for high heat/radiation resistance)
...
print("=== 2. Loading DAGMC Geometry with Vacuum Boundary ===")
...
print("=== 4. Setting up Tallies (First Wall, TBR, Divertor, & Mesh) ===")
...
# 3D Spatial Mesh Tally (Heating Distribution)
...
print("=== 5. Running OpenMC Simulation with Divertor ===")
...
print("\n========================================")
print("     FULL REACTOR WITH DIVERTOR RESULTS ")
print("========================================")
...
mesh.write_data_to_vtk('spatial_heating_with_divertor.vtk', datasets={'heating': heating_data})
print("\n[+] Updated 3D Mesh Tally exported to 'spatial_heating_with_divertor.vtk'!")
