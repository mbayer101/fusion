...
print("Running Simulation with Lead Multiplier and 40 cm PbLi Blanket...")
...
# --- 2. DEFINE GEOMETRY WITH 40 CM BLANKET ---
r_plasma = 0.5
r_wall = 0.55
r_multiplier = r_wall + 5.0      # 5 cm Lead multiplier layer
r_blanket = r_multiplier + 40.0  # UPDATED: 40 cm PbLi blanket
...
with openmc.StatePoint(sp_filename) as sp:
    ...
    print('\n==================================================')
    print('    LEAD MULTIPLIER + 40 CM BLANKET RESULTS       ')
    print('==================================================')
