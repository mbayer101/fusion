...
print("Running Simulation with Beryllium Neutron Multiplier...")
...
# New Beryllium Multiplier Material
beryllium = openmc.Material(name='Beryllium-Multiplier')
...
materials = openmc.Materials([dt_fuel, tungsten, beryllium, pbli, rafm])
materials.export_to_xml()

# --- 2. DEFINE GEOMETRY WITH BERYLLIUM LAYER ---
r_plasma = 0.5
r_wall = 0.55
r_multiplier = r_wall + 5.0      # 5 cm Beryllium layer (0.55 to 5.55 cm)
r_blanket = r_multiplier + 30.0  # 30 cm PbLi blanket (5.55 to 35.55 cm)
...
cell_multiplier = openmc.Cell(fill=beryllium, region=region_multiplier)
...
# Heating Tally covering Wall, Multiplier, and Blanket
...
with openmc.StatePoint(sp_filename) as sp:
    ...
    print('\n==================================================')
    print('        BERYLLIUM MULTIPLIER RESULTS              ')
    print('==================================================')
    ...
    for _, row in df_heat.iterrows():
        ...
        cell_name = "Tungsten Wall" if c_id == 2 else ("Be Multiplier" if c_id == 3 else "PbLi Blanket")
