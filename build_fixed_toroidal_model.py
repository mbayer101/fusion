...
print("Building Fixed 3D Toroidal Fusion Model with Enriched Blanket...")
...
R0 = 600.0
# ZTorus parameters: x0, y0, z0, a (major radius), b (z-minor radius), c (xy-minor radius)
surf_plasma = openmc.ZTorus(x0=0.0, y0=0.0, z0=0.0, a=R0, b=200.0, c=200.0, id=1)
surf_fw     = openmc.ZTorus(x0=0.0, y0=0.0, z0=0.0, a=R0, b=210.0, c=210.0, id=2)
surf_mult   = openmc.ZTorus(x0=0.0, y0=0.0, z0=0.0, a=R0, b=220.0, c=220.0, id=3)
surf_bl     = openmc.ZTorus(x0=0.0, y0=0.0, z0=0.0, a=R0, b=280.0, c=280.0, id=4)
surf_struct = openmc.ZTorus(x0=0.0, y0=0.0, z0=0.0, a=R0, b=290.0, c=290.0, id=5)
surf_shield = openmc.ZTorus(x0=0.0, y0=0.0, z0=0.0, a=R0, b=350.0, c=350.0, id=6)
...
print("Toroidal model built and exported successfully with correct ZTorus syntax!")
