...
print("Building Final 3D Toroidal Fusion Model with Vacuum Boundary...")
...
surf_plasma = openmc.ZTorus(x0=0.0, y0=0.0, z0=0.0, a=R0, b=200.0, c=200.0, id=101)
surf_fw     = openmc.ZTorus(x0=0.0, y0=0.0, z0=0.0, a=R0, b=210.0, c=210.0, id=102)
surf_mult   = openmc.ZTorus(x0=0.0, y0=0.0, z0=0.0, a=R0, b=220.0, c=220.0, id=103)
surf_bl     = openmc.ZTorus(x0=0.0, y0=0.0, z0=0.0, a=R0, b=280.0, c=280.0, id=104)
surf_struct = openmc.ZTorus(x0=0.0, y0=0.0, z0=0.0, a=R0, b=290.0, c=290.0, id=105)

# Outermost shield surface with Vacuum boundary condition
surf_shield = openmc.ZTorus(x0=0.0, y0=0.0, z0=0.0, a=R0, b=350.0, c=350.0, id=106)
surf_shield.boundary_type = 'vacuum'
...
print("Toroidal model built and exported successfully with vacuum boundary!")
