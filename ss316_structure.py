...
print("Running Simulation with Compatible Structure and 50% Li-6...")
...
# Optimized 50% Li-6 enrichment blanket
...
# Library-compatible structural steel (Fe-Cr alloy)
structural_steel = openmc.Material(name='Fe-Cr-Structure')
structural_steel.add_element('Fe', 88.0, 'wo')
structural_steel.add_element('Cr', 12.0, 'wo')
structural_steel.set_density('g/cm3', 7.8)

materials = openmc.Materials([dt_fuel, tungsten, lead_multiplier, pbli, structural_steel])
...
cell_struct = openmc.Cell(fill=structural_steel, region=region_struct)
...
with openmc.StatePoint(sp_filename) as sp:
    ...
    print('\n==================================================')
    print('    COMPATIBLE STRUCTURE + 50% ENRICHMENT RESULTS ')
    print('==================================================')
    ...
    cell_names = {
        ...
        cell_struct.id: "Fe-Cr Structure"
    }
