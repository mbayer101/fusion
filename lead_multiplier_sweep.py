...
print("Running Simulation with Lead Neutron Multiplier...")
...
# New Lead Multiplier Material (Natural Lead composition)
...
# --- 2. DEFINE GEOMETRY WITH LEAD LAYER ---
r_plasma = 0.5
r_wall = 0.55
r_multiplier = r_wall + 5.0      # 5 cm Lead multiplier layer (0.55 to 5.55 cm)
r_blanket = r_multiplier + 40.0  # 40 cm PbLi blanket (5.55 to 45.55 cm)
